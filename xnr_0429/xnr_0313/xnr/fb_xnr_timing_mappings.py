...
def fb_xnr_timing_list_mappings():
	...
	if not es.indices.exists(index=fb_xnr_timing_list_index_name):
		es.indices.create(index=fb_xnr_timing_list_index_name,body=index_info,ignore=400)


if __name__ == '__main__':

	fb_xnr_timing_list_mappings()