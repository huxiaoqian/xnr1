...
# es.indices.delete(index='facebook_flow_text_2017-09-10')
# es.indices.delete(index='facebook_flow_text_2017-09-11')
# es.indices.delete(index='facebook_flow_text_2017-09-12')
# es.indices.delete(index='facebook_flow_text_2017-09-13')
# es.indices.delete(index='facebook_flow_text_2017-09-14')
# es.indices.delete(index='facebook_flow_text_2017-09-15')
# es.indices.delete(index='facebook_flow_text_2017-09-16')
# es.indices.delete(index='facebook_flow_text_2017-09-17')
# es.indices.delete(index='facebook_flow_text_2017-09-18')
# es.indices.delete(index='facebook_flow_text_2017-09-19')
# es.indices.delete(index='facebook_flow_text_2017-09-20')
# es.indices.delete(index='facebook_flow_text_2017-09-21')
# es.indices.delete(index='facebook_flow_text_2017-09-22')
# es.indices.delete(index='facebook_flow_text_2017-09-23')
# es.indices.delete(index='facebook_flow_text_2017-09-24')
# es.indices.delete(index='facebook_flow_text_2017-09-25')
# es.indices.delete(index='facebook_flow_text_2017-09-26')
# es.indices.delete(index='facebook_flow_text_2017-09-27')
# es.indices.delete(index='facebook_flow_text_2017-09-28')
# es.indices.delete(index='facebook_flow_text_2017-09-29')
# es.indices.delete(index='facebook_flow_text_2017-09-30')

# es.indices.delete(index='facebook_flow_text_2017-10-01')
# es.indices.delete(index='facebook_flow_text_2017-10-02')
# es.indices.delete(index='facebook_flow_text_2017-10-03')
# es.indices.delete(index='facebook_flow_text_2017-10-04')
# es.indices.delete(index='facebook_flow_text_2017-10-05')
# es.indices.delete(index='facebook_flow_text_2017-10-06')
# es.indices.delete(index='facebook_flow_text_2017-10-07')
# es.indices.delete(index='facebook_flow_text_2017-10-08')
# es.indices.delete(index='facebook_flow_text_2017-10-09')
# es.indices.delete(index='facebook_flow_text_2017-10-10')
# es.indices.delete(index='facebook_flow_text_2017-10-11')
# es.indices.delete(index='facebook_flow_text_2017-10-12')
# es.indices.delete(index='facebook_flow_text_2017-10-13')
# es.indices.delete(index='facebook_flow_text_2017-10-14')
# es.indices.delete(index='facebook_flow_text_2017-10-15')
# es.indices.delete(index='facebook_flow_text_2017-10-16')
# es.indices.delete(index='facebook_flow_text_2017-10-17')
# es.indices.delete(index='facebook_flow_text_2017-10-18')
# es.indices.delete(index='facebook_flow_text_2017-10-19')
# es.indices.delete(index='facebook_flow_text_2017-10-20')
# es.indices.delete(index='facebook_flow_text_2017-10-21')
# es.indices.delete(index='facebook_flow_text_2017-10-22')
# es.indices.delete(index='facebook_flow_text_2017-10-23')
# es.indices.delete(index='facebook_flow_text_2017-10-24')
# es.indices.delete(index='facebook_flow_text_2017-10-25')
# es.indices.delete(index='facebook_flow_text_2017-10-26')
# es.indices.delete(index='facebook_flow_text_2017-10-27')
# es.indices.delete(index='facebook_flow_text_2017-10-28')
# es.indices.delete(index='facebook_flow_text_2017-10-29')
# es.indices.delete(index='facebook_flow_text_2017-10-30')
# es.indices.delete(index='facebook_flow_text_2017-10-31')
# es.indices.delete(index='facebook_flow_text_2017-11-01')

# es.indices.delete(index='twitter_flow_text_2013-09-11')
# es.indices.delete(index='twitter_flow_text_2013-09-13')
# es.indices.delete(index='twitter_flow_text_2013-09-14')
# es.indices.delete(index='twitter_flow_text_2013-09-15')
# es.indices.delete(index='twitter_flow_text_2013-09-17')
# es.indices.delete(index='twitter_flow_text_2013-09-20')
# es.indices.delete(index='twitter_flow_text_2013-09-22')
# es.indices.delete(index='twitter_flow_text_2013-09-25')
# es.indices.delete(index='twitter_flow_text_2015-06-01')


# es.indices.delete(index='twitter_flow_text_2013-06-15')
# es.indices.delete(index='twitter_flow_text_2013-06-06')
# es.indices.delete(index='twitter_flow_text_2013-06-07')
# es.indices.delete(index='twitter_flow_text_2013-06-08')
# es.indices.delete(index='twitter_flow_text_2013-06-15')
# es.indices.delete(index='twitter_flow_text_2013-06-16')
# es.indices.delete(index='twitter_flow_text_2013-06-18')
# es.indices.delete(index='twitter_flow_text_2013-06-20')
# es.indices.delete(index='twitter_flow_text_2013-06-21')
# es.indices.delete(index='twitter_flow_text_2013-07-07')
# es.indices.delete(index='twitter_flow_text_2013-07-08')
# es.indices.delete(index='twitter_flow_text_2013-07-10')
# es.indices.delete(index='twitter_flow_text_2013-07-11')

# es.indices.delete(index='fb_bci_2017-10-12')
# es.indices.delete(index='fb_bci_2017-10-25')



# es.indices.delete(index='twitter_flow_text_2017-10-10')
# es.indices.delete(index='twitter_flow_text_2017-10-11')
# es.indices.delete(index='twitter_flow_text_2017-10-12')
# es.indices.delete(index='twitter_flow_text_2017-10-13')
# es.indices.delete(index='twitter_flow_text_2017-10-14')
# es.indices.delete(index='twitter_flow_text_2017-10-15')
# es.indices.delete(index='twitter_flow_text_2017-10-16')
# es.indices.delete(index='twitter_flow_text_2017-10-17')
# es.indices.delete(index='twitter_flow_text_2017-10-18')
# es.indices.delete(index='twitter_flow_text_2017-10-19')
# es.indices.delete(index='twitter_flow_text_2017-10-20')
# es.indices.delete(index='twitter_flow_text_2017-10-21')
# es.indices.delete(index='twitter_flow_text_2017-10-22')
# es.indices.delete(index='twitter_flow_text_2017-10-23')
# es.indices.delete(index='twitter_flow_text_2017-10-24')
# es.indices.delete(index='twitter_flow_text_2017-10-25')
# es.indices.delete(index='twitter_flow_text_2017-10-26')
# es.indices.delete(index='twitter_flow_text_2017-10-27')
# es.indices.delete(index='twitter_flow_text_2017-10-28')
# es.indices.delete(index='twitter_flow_text_2017-10-29')
# es.indices.delete(index='twitter_flow_text_2017-10-30')
# es.indices.delete(index='twitter_flow_text_2017-10-31')
# es.indices.delete(index='twitter_flow_text_2017-11-01')

# es.indices.delete(index='twitter_flow_text_2017*')
# es.indices.delete(index='twitter_flow_text_2015*')
