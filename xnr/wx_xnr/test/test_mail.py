...
def send(from_user, to_user, content):
    msg = MIMEMultipart()
...
def send_qrcode2mail():
    ...
    to_user = {
        'name': '管理员',
        'addr': 'feifanhanmc@163.com'  #支持多个，以逗号隔开
    }
    return send(from_user=from_user, to_user=to_user, content=content)


if __name__ == '__main__':
    print send_qrcode2mail()
