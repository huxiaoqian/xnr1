...
def lpush_recommend_subopinion_keyword_task_list():
	...
	compute_status = 0
	es_results = es.search(index=tw_hot_keyword_task_index_name,doc_type=tw_hot_keyword_task_index_type,\
	...
	if es_results:
		for item in es_results:
			...
			r_r.lpush(tw_recommend_subopinion_keywords_task_queue_name,json.dumps(task_dict))
			count += 1
			print '开始把任务push到队列中......'
