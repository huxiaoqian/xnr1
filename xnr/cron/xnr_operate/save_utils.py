...
def save_content_recommendation_results(xnr_user_no,mid,task_id,content_results):
    ...
    es.update(index=social_sensing_index_name,doc_type=social_sensing_index_type,id=task_id,\
...
def save_subopnion_results(xnr_user_no,mid,task_id,sub_opinion_results):
    ...
    print 'es::',es
    result = es.get(index=social_sensing_index_name,doc_type=social_sensing_index_type,id=task_id)
    print 'result:::',result
    es.update(index=social_sensing_index_name,doc_type=social_sensing_index_type,id=task_id,\
