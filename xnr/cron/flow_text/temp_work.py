...
def get_root_retweet(text, root_uid):
    ...
    # RE = re.compile(u'RT @([a-zA-Z-_⺀-⺙⺛-⻳⼀-⿕々〇〡-〩〸-〺〻㐀-䶵一-鿃豈-鶴侮-頻並-龎 ]+)(@([a-zA-Z-_⺀-⺙⺛-⻳⼀-⿕々〇〡-〩〸-〺〻㐀-䶵一-鿃豈-鶴侮-頻並-龎 ]+)):', re.UNICODE)
...
if __name__ == '__main__':
    ...
    #                 if sensitive > 0:
    #                     print data['sensitive_words_string']
    #                     print data['sensitive']
    #             except:
    #                 print 'data....',data
