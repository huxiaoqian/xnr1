...
$('.pc-4 input').on('click',function () {
    ...
    var the_url='';
    if (t=='area'){
        the_url='/twitter_xnr_assessment/safe_tweets_topic/?xnr_user_no='+ID_Num+'&topic='+the+'&sort_item='+theSort;
    }else {
        the_url='/twitter_xnr_assessment/follow_group_tweets/?xnr_user_no='+ID_Num+'&domain='+the+'&sort_item='+theSort;
    }
