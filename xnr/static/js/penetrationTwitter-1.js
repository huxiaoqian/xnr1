...
$('.choosetime .demo-label input').on('click',function () {
    ...
    if (_val=='mize'){
        ...
        public_ajax.call_request('get',historyTotal_url,historyTotal);
        //曲线图 1
        var penetration_7day_url='/twitter_xnr_manage/lookup_xnr_assess_info/?xnr_user_no='+ID_Num+
        ...
        //曲线图 2
        var penetration_url='/twitter_xnr_assessment/'+midURL+'/?xnr_user_no='+ID_Num+lastURL;
...
$('.sureTime').on('click',function () {
    ...
    if (s==''||d==''){
        ...
        public_ajax.call_request('get',penetration_7day_url,penetration_7day);
        //曲线图 2
        var penetration_url='/twitter_xnr_assessment/penetration_total/?xnr_user_no='+ID_Num+
            '&start_time='+start+'&end_time='+end+'&assess_type=penetration';
        public_ajax.call_request('get',penetration_url,penetration);
    }
});
...
var scoreUrl='/twitter_xnr_assessment/penetration_mark/?xnr_user_no='+ID_Num;
public_ajax.call_request('get',scoreUrl,score);
function score(data) {
    $('.title .tit-2 .score').text(data);
}
var defaultUrl='/twitter_xnr_assessment/penetration_total/?xnr_user_no='+ID_Num+
    '&start_time='+getDaysBefore('7')+'&end_time='+end_time+'&assess_type=penetration';;
