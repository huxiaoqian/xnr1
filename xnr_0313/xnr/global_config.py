...
ES_FLOW_TEXT_HOST = ['10.128.55.75:9200','10.128.55.76:9200']
		#['219.224.134.216:9201', '219.224.134.217:9201',\
                    #      '219.224.134.218:9201']
ES_FLOW_TEXT_PORT = '9200'
...
ES_USER_PORTRAIT_HOST = ['10.128.55.69:9200','10.128.55.70:9200','10.128.55.71:9200']
			#['219.224.134.216:9201', '219.224.134.217:9201',\
                     #'219.224.134.218:9201']
ES_USER_PORTRAIT_PORT = '9200'

#es_path
ES_PATH = '/home/pkgs/elasticsearch-1.6.0/'

#config redis
REDIS_HOST = '10.128.55.68' #'219.224.134.212'
REDIS_PORT = '6379' #'7392'

REDIS_CLUSTER_HOST_FLOW2 = '10.128.55.68' #'219.224.134.213'
REDIS_CLUSTER_PORT_FLOW2 = '6379' #'6666'
...
##　 weibo敏感词redis
REDIS_CLUSTER_HOST_FLOW3 = '10.128.55.71' #'219.224.134.214' #'10.128.55.71'
REDIS_CLUSTER_PORT_FLOW3 = '6379'

REDIS_HOST_SENSITIVE = '10.128.55.68' #'219.224.134.212'
REDIS_PORT_SENSITIVE = '6379' #'6381'

#wx redis
REDIS_WX_PORT = '6379' #6660
REDIS_WX_HOST = '10.128.55.68' #'219.224.134.213'
...
#微信多媒体数据存放地址
WX_IMAGE_ABS_PATH = '/home/xnr1/xnr_0313/xnr/static/WX/image'
WX_VOICE_ABS_PATH = '/home/xnr1/xnr_0313/xnr/static/WX/voice'
