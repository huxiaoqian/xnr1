...
from tw_xnr_flow_text_mappings import tw_daily_inerests_flow_text_mappings


sys.path.append('../../')

from global_utils import es_xnr, twitter_flow_text_index_name_pre, twitter_flow_text_index_type,\
					tw_daily_interest_index_name_pre,tw_daily_interest_index_type
...
def read_flow_text(flow_text_index_name,current_date):
	...
	for content_label,content_weibo in content_dict.iteritems():
		...
		print es_xnr.index(index=index_name,doc_type=tw_daily_interest_index_type,id=_id,body=item_dict)
